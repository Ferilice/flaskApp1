...
def lab11_db_BlogEntry():
    ...
    app.logger.debug("DB BlogEntry: " + str(blog_entries))
    ...
    if request.method == 'POST':
        ...
        if validated:
            ...
            # if there is an id already: update the blog entry
                ...
                blogsss = BlogEntry.query.get(id_)
                blogsss.update(**validated_dict)
